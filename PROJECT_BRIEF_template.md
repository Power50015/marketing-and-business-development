...
> [4–6 sentences. What it is, who it serves, what makes it different, current stage, #1 challenge]
...
> "We help [TARGET CUSTOMER] to [SOLVE SPECIFIC PROBLEM] by [UNIQUE APPROACH], unlike [ALTERNATIVE] which [ITS LIMITATION]."
...
| Metric | Value | Status |
|---|---|---|
| **CAC** | | Known / Estimated / Unknown |
| **LTV** | | Known / Estimated / Unknown |
| **LTV:CAC Ratio** | | Healthy / At Risk / Unknown |
| **Payback Period** | | |
...
## 🗺️ STRATEGIC FRAMEWORKS SELECTED
...
|---|---|---|
| `business_strategy_template_general.md` | Overall strategic direction | |
| `action_plan_template_EN.md` | Execution planning | |
| `ecommerce_strategy_template.md` | If e-commerce is core | |

---

## ✅ AI VERIFICATION CHECKLIST

> Any AI reading this file must be able to check all boxes before proceeding.

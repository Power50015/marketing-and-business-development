<!--
  ════════════════════════════════════════════════════════════════════
  360° BUSINESS DISCOVERY SYSTEM — VERSION 2.1
  ════════════════════════════════════════════════════════════════════
...
confidence_level: "[XX]%"
generated_by: "360° Business Discovery System v2.1"
priority_frameworks:
  - "[Framework 1 name]"
  - "[Framework 2 name]"
priority_skills:
...
## 🗺️ STRATEGIC MAP — FRAMEWORKS & SKILLS SELECTED
...
Frameworks/Business_Models/
├── business_model_canvas_template.md
├── lean_canvas_template.md
├── value_disciplines_model_template.md
...
Frameworks/Finance_and_Risk/
├── break_even_analysis_template.md
├── cost_benefit_analysis_template.md
...
├── kano_model_template.md
└── three_horizons_template.md

Frameworks/Internal_Analysis/
├── digital_transformation_strategy_template.md
├── five_stages_of_business_growth_template.md
├── profitability_tree_template.md
└── swot_tows_template.md

Frameworks/Marketing_and_Customers/
├── customer_journey_map_template.md
├── jtbd_framework_template.md
├── marketing_mix_4ps_7ps_template.md
├── north_star_metric_template.md
└── stp_framework_template.md

Frameworks/Operations_and_Projects/
├── kotter_8_step_model_template.md
├── pdca_cycle_template.md
├── raci_matrix_template.md
└── smart_goals_template.md

Frameworks/Performance_and_Measurement/
├── balanced_scorecard_template.md
└── okrs_template.md
...
Frameworks/Thinking_and_Problem_Solving/
├── mece_issue_tree_template.md
├── pyramid_principle_template.md
└── root_cause_analysis_template.md

Frameworks/Time_and_Priority_Management/
├── eisenhower_matrix_template.md
└── moscow_method_template.md
...
**If you checked all 14 boxes:** You have sufficient context. Proceed with confidence.
...
_Document generated by: 360° Business Discovery System v2.1_
_Generation Date: [DATE]_
_Discovery Confidence: [XX]%_
_Next Review: [DATE — recommended: after applying Priority 1 frameworks]_
...
| **Hoshin Kanri**              | Areas 1, 5 (Vision + OKRs) — strategy deployment         |
...
□ The AI Verification Checklist has answers to all 14 items
...
_360° Business Discovery System — Version 2.1_
